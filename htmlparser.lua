...
-- }}}
-- Requires {{{
local ElementNode = loadstring(game:HttpGet("https://raw.githubusercontent.com/KitesBackup/lua-htmlparser/main/ElementNode.lua"))()
local voidelements = loadstring(game:HttpGet("https://raw.githubusercontent.com/KitesBackup/lua-htmlparser/main/voidelements.lua"))()
--}}}
local HtmlParser = {}
